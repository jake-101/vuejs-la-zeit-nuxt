...
async asyncData({ store, $axios }) {
    ...
    const getProductbyId3 = await $axios.$get(
      ...
      `${process.env.API_URL}/api/getproduct?id=8124`
        ...
        const getProductbyIda = await $axios.$get(
      `${process.env.API_URL}/api/getproduct?id=13747`
    );

    const getProductbyId2a = await $axios.$get(
      `${process.env.API_URL}/api/getproduct?id=51401`
    );

    const getProductbyId3a = await $axios.$get(
      `${process.env.API_URL}/api/getproduct?id=8128`
    );

        const getProductbyId4a = await $axios.$get(
      `${process.env.API_URL}/api/getproduct?id=12477`
    );

            const getProductbyId5a = await $axios.$get(
      `${process.env.API_URL}/api/getproduct?id=8124`
    );
    return {
      ...
      product5: getProductbyId5.productBy,
        producta: getProductbyIda.productBy,
      product2a: getProductbyId2a.productBy,
      product3a: getProductbyId3a.productBy,
      product4a: getProductbyId4a.productBy,
      product5a: getProductbyId5a.productBy,
      id: 13747
    };
  },
  components: {
